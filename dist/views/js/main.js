...
var resizePizzas = function(size) {
  ...
  //****No longer need this due to refactoring*****
  ...
  function changePizzaSizes(size) {
    switch(size) {
      ...
      case "3":
        ...
        break;
      default:
        console.log("bug in switcher");
    }

//Move selector out of for loop to reduce forced layout
...
/*    for (var i = 0; i < randomPizzas.length; i++) {
    ...
    for (var i = 0; i < randomPizzas.length; i++) {
        document.querySelectorAll(randomPizzas[i]).style.width = newwidth;
    }*/
  }
...
//**Moved pizzaDiv out of loop to increase performance
...
//Moved '.mover' selector out of loop to reduce forced layout reflow

  var items = document.querySelectorAll('.mover');
  var currScrollPos = document.body.scrollTop;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin((currScrollPos / 1250) + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var s = 256;
  var numPizzas = 0;
  //change number of scrolling pizzas based on screen height
  ...
  console.log(screen.height + " " + numPizzas);
